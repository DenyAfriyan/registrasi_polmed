                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" action="<?= base_url(); ?>/mahasiswa/saveFinalisasiData" method="post">
                                      <?= csrf_field(); ?>
                                      <h4>Biodata dan Berkas <?=$users->nama_lengkap?></h4>
                                       ...
                                       <div class="form-group row">
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <textarea class="form-control" id="alamat" name="alamat" rows="5" disabled><?=$users->alamat;?></textarea>
                                            </div>
                                        </div>
                                       <div class="form-group row">
                                      ...
                                      <div class="form-group row">
                                       ...
                                       <div class="form-group row">
                                            <div class="col-lg">
                                                <h5>Mohon di cek kembali!!! Klik tombol finalisasi data berarti anda menyetujui data yang sudah anda isikan benar</h5>
                                            </div>
                                        </div>
                                      	<div class="form-group row">
                                            <div class="col-lg-6">
                                                <button type="submit" class="btn btn-primary">Finalisasi Data</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
