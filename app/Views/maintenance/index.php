...
<head>
    ...
    <meta name="viewport" content="width=device-width,initial-scale=1">
    <title>Registrasi PoliMedia</title>
                    ...
                    <div class="error-content">
                        <div class="card mb-0">
                            <div class="card-body text-center pt-5">
                                <!--<h1 class="error-text text-primary">Pengumuman</h1>-->
                                <h4 class="mt-4 mb-4">Registrasi daftar ulang dapat dilakukan mulai pukul 18.00 WIB</h4>
                                ...
                                <div class="text-center">
                                    <p>Copyright © 2022 <a href="https://polimedia.ac.id">Politeknik Negeri Media Kreatif</a></p>
